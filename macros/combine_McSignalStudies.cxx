...
void combine_McSignalStudies()
{
	...
	Plotter_standard(motherDir, outputDir, vecHiggsMassToUse, vecSusyMassToUse, tailArgument, "detectorLeadingAk4JetEta", "detectorLeadingAk4JetEta", 0.69, 0.88, 0.67, 0.87, false, true);
	Plotter_standard(motherDir, outputDir, vecHiggsMassToUse, vecSusyMassToUse, tailArgument, "detectorSecondaryAk4JetEta", "detectorSecondaryAk4JetEta", 0.69, 0.88, 0.67, 0.87, false, true);
