...
process.source = cms.Source("PoolSource",
    ...
    # fileNames = cms.untracked.vstring('/store/mc/RunIISpring16DR80/QCD_Pt-15to3000_TuneCUETP8M1_Flat_13TeV_pythia8/AODSIM/FlatPU20to70HcalNZSRAW_withHLT_80X_mcRun2_asymptotic_v14-v1/40000/0266A736-8B64-E611-8BBB-0CC47A7C360E.root'),
...
process.out.outputCommands = cms.untracked.vstring( ['drop *',
                                                     ...
                                                     'keep *_selectedPatJetsAK4PFCHS_tagInfos_*',
